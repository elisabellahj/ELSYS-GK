...
def easy():
    ...
    easyQ = [
                ...
                [
                    ...
                    "Lists",
                    "Class",
                    "C:\\elsys_files\\forsidebakgrunn1.png"
                ],
                [
    ...
    a = Button(easy_canvas,text=easyQ[x][1],font="calibri 10", bg="#00FF00")
    a.place(relx=0.5,rely=0.42,anchor=CENTER)
    e.bind('1', callback1)
    e.bind('5', callback5)

    b = Button(easy_canvas,text=easyQ[x][2],font="calibri 10", bg="#00FF00")
    b.place(relx=0.5,rely=0.52,anchor=CENTER)
    e.bind('2', callback2)
    e.bind('6', callback6)

    c = Button(easy_canvas,text=easyQ[x][3],font="calibri 10", bg="#00FF00")
    c.place(relx=0.5,rely=0.62,anchor=CENTER) 
    e.bind('3', callback3)
    e.bind('7', callback7)

    d = Button(easy_canvas,text=easyQ[x][4],font="calibri 10", bg="#00FF00")
...
def medium():
    ...
    m.focus_force()
    med_canvas = Canvas(m,width=1920,height=1080,bg="#101357")
    med_canvas.pack()
